  ...
  module ApplicationHelperPatch
    ...
    module InstanceMethods
      def link_to_attachment(attachment, options={})
        ...
        link_to(sprite_icon('zoom-in', l('redmica_ui_extension.preview_attachment.preview')), '#', :title => l('redmica_ui_extension.preview_attachment.preview'), :class => 'preview-attachment icon icon-zoom-in',
